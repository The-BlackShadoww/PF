...
export function SectorsBreakdown({
  summary,
  dark = false,
}: {
  ...
  const segments = [
    ...summary.sectors,
    {
      ...summary.cash,
      id: "cash",
      targetAmountCents: null as number | null,
          ...
          <div key={s.id}>
            <div className="flex items-center justify-between gap-3 text-xs">
              ...
              <span className={cn("font-semibold", text)}>
                {formatDollar(s.allocatedCents / 100)}
              </span>
            </div>
            {s.targetAmountCents !== null && (
              <div className="mt-1 ml-4 h-1 overflow-hidden rounded bg-black/10">
                <div
